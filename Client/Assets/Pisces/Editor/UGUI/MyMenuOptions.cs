...
namespace PiscesEditor.UI
{
    static internal class MyMenuOptions
    {
        ...
        static private MyDefaultControls.Resources GetStandardResources()
        {
        ...
        private class DefaultEditorFactory : MyDefaultControls.IFactoryControls
        {
        ...
        {
            MyDefaultControls.IFactoryControls factory;

            public FactorySwapToEditor()
            {
                factory = MyDefaultControls.factory;
                MyDefaultControls.factory = DefaultEditorFactory.Default;
            }

            public void Dispose()
            {
                MyDefaultControls.factory = factory;
            }
        }
        ...
        static public void AddText(MenuCommand menuCommand)
        {
            ...
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateText(GetStandardResources());
        ...
        static public void AddRawImage(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateRawImage(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        static public void AddToggle(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateToggle(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        static public void AddSlider(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateSlider(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        static public void AddScrollbar(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateScrollbar(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        static public void AddDropdown(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateDropdown(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        public static void AddInputField(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateInputField(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        static public void AddPanel(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreatePanel(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        ...
        static public void AddScrollView(MenuCommand menuCommand)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = MyDefaultControls.CreateScrollView(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
