...
{
    [CustomPropertyDrawer(typeof(MyNavigation), true)]
    /// <summary>
    /// This is a PropertyDrawer for MyNavigation. It is implemented using the standard Unity PropertyDrawer framework.
    /// </summary>
    public class MyNavigationDrawer : PropertyDrawer
    {
        private class Styles
        {
            ...
            public Styles()
            {
                navigationContent = EditorGUIUtility.TrTextContent("MyNavigation");
            }
        }
        ...
        public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
        {
            ...
            MyNavigation.Mode navMode = GetNavigationMode(navigation);
            ...
            switch (navMode)
            {
                case MyNavigation.Mode.Horizontal:
                case MyNavigation.Mode.Vertical:
                {
                    EditorGUI.PropertyField(drawRect, wrapAround);
                    drawRect.y += EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing;
                }
                break;
                case MyNavigation.Mode.Explicit:
                {
        ...
        static MyNavigation.Mode GetNavigationMode(SerializedProperty navigation)
        {
            return (MyNavigation.Mode)navigation.enumValueIndex;
        }
