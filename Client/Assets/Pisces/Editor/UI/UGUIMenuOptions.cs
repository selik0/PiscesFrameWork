// using System.IO;
// /****************
//  *@class name:		UGUIMenuOptions
//  *@description:		创建ugui的菜单
//  *@author:			selik0
//  *@date:			2023-02-04 14:12:40
//  *@version: 		V1.0.0
// *************************************************************************/
// using System;
...
// {
//     public static class UGUIMenuOptions
//     {
//         private const string kUILayerName = "UI";

//         private const string kStandardSpritePath = "Assets/MyAssets/Textures/StaticPack/Default/UISprite.png";
//         private const string kBackgroundSpritePath = "Assets/MyAssets/Textures/StaticPack/Default/Background.png";
//         private const string kInputFieldBackgroundPath = "Assets/MyAssets/Textures/StaticPack/Default/Background.png";
//         private const string kKnobPath = "Assets/MyAssets/Textures/StaticPack/Default/Knob.png";
//         private const string kCheckmarkPath = "Assets/MyAssets/Textures/StaticPack/Default/Checkmark.png";
//         private const string kDropdownArrowPath = "Assets/MyAssets/Textures/StaticPack/Default/DropdownArrow.png";
//         private const string kMaskPath = "Assets/MyAssets/Textures/StaticPack/Default/UIMask.png";
...
//             {
//                 s_StandardResources.standard = AssetDatabase.LoadAssetAtPath<Sprite>(kStandardSpritePath);
//                 s_StandardResources.background = AssetDatabase.LoadAssetAtPath<Sprite>(kBackgroundSpritePath);
//                 s_StandardResources.inputField = AssetDatabase.LoadAssetAtPath<Sprite>(kInputFieldBackgroundPath);
//                 s_StandardResources.knob = AssetDatabase.LoadAssetAtPath<Sprite>(kKnobPath);
//                 s_StandardResources.checkmark = AssetDatabase.LoadAssetAtPath<Sprite>(kCheckmarkPath);
//                 s_StandardResources.dropdown = AssetDatabase.LoadAssetAtPath<Sprite>(kDropdownArrowPath);
//                 s_StandardResources.mask = AssetDatabase.LoadAssetAtPath<Sprite>(kMaskPath);
//             }
...
//                 GameObject canvas = UGUIMenuOptions.CreateNewUI();
...
//         static void ReplaceText2TextMeshUGUI(GameObject go)
//         {
...
//             {
//                 GameObject target = texts[i].gameObject;
//                 Component.DestroyImmediate(texts[i]);
...
//         [MenuItem("GameObject/UI/LongPressButton", false, 2030)]
//         static public void AddLongPressButton(MenuCommand menuCommand)
//         {
//             GameObject go;
//             using (new FactorySwapToEditor())
//                 go = DefaultControls.CreateButton(GetStandardResources());
...
//             go.AddComponent<LongPressButton>();

//             ReplaceText2TextMeshUGUI(go);
//         }

//         [MenuItem("GameObject/UI/StateButton", false, 2030)]
//         static public void StateButton(MenuCommand menuCommand)
//         {
//             GameObject go;
//             using (new FactorySwapToEditor())
//                 go = DefaultControls.CreateButton(GetStandardResources());
...
//             return UGUIMenuOptions.CreateNewUI();
//         }
