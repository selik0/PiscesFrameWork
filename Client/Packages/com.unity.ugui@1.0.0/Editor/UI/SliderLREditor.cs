    ...
    public class SliderLREditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_FillRect.objectReferenceValue != null || m_HandleRect.objectReferenceValue != null)
            {
                ...
                foreach (var obj in serializedObject.targetObjects)
                {
                    SliderLR slider = obj as SliderLR;
                    SliderLR.Direction dir = slider.direction;
                    if (dir == SliderLR.Direction.LeftRight)
